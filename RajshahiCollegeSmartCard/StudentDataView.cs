...
{
    public partial class StudentDataView : Form
    {
        ...
        {
            Student student = Program.GetResponseData(rollTextBox.Text);
            fullNameTextBox.Text = student.name;
            departmentTextBox.Text = student.dept_name;
            sessionTextBox.Text = student.session;
            facultyTextBox.Text = student.faculty_name;
            statusTxtbox.Text = student.status;
            currentLevelTextBox.Text = student.current_level;
            regStatusTextBox.Text = student.registration_status;
            ...
            contNumberTextBox.Text = student.contact_no;
        ...
        private void readCard()
        {
            try
            {
                ...
                if (RCDESFire.RCReadFile(0x02, ref ReadBuffer, ref cardresponse))
                {
                    ...
                    facultyTextBox.Text = splt[2].ToString();
                    genderTextBox.Text = splt[3].ToString();
                    religionTextBox.Text = splt[4].ToString();
                    sessionTextBox.Text = splt[5].ToString();
                    departmentTextBox.Text = splt[6].ToString();

                    currentLevelTextBox.Text = (splt[7] != null ? splt[7].ToString() : "");
                ...
                if (RCDESFire.RCReadFile(0x03, keys[2], ref ReadBuffer, ref cardresponse))
                {
                    ...
                    contNumberTextBox.Text = splt[1].ToString();
                    regStatusTextBox.Text = splt[2].ToString();
        ...
        private string SetBasicInfo()
        {
            return rollTextBox.Text + Environment.NewLine +
                ...
                facultyTextBox.Text + Environment.NewLine +
                genderTextBox.Text + Environment.NewLine +
                religionTextBox.Text + Environment.NewLine +
                sessionTextBox.Text + Environment.NewLine +
                departmentTextBox.Text + Environment.NewLine +
                currentLevelTextBox.Text + Environment.NewLine;
        ...
        {
            return dobTextBox.Text + Environment.NewLine + contNumberTextBox.Text + contNumberTextBox.Text + Environment.NewLine + regStatusTextBox.Text + Environment.NewLine + fathersNameTextBox.Text + Environment.NewLine + mothernameTextBox.Text + Environment.NewLine;
        }
